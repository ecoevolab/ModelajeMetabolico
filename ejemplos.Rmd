...
## 1. Contenedor de COMETS en DockerDesktop 
```te
...
#export GUROBI_COMETS_HOME=/opt/gurobi1003/linux64
#export GRB_LICENSE_FILE=/root/gurobi.lic
#export LD_LIBRARY_PATH=/opt/gurobi1003/linux64/lib:$LD_LIBRARY_PATH

#python3 -m pip install ortools

python3 ModelajeMetabolico/scr/sim_syncom_comets.py --gem_path ModelajeMetabolico/modelos --strains Rerythropolis --media lb --cycles 10000 --threads 1 --outdir ./Rerythropolis
...
```{}
python3 ModelajeMetabolico/scr/sim_syncom_comets.py --gem_path ModelajeMetabolico/modelos --strains Rerythropolis --media lb --cycles 10000 --threads 1 --outdir ./Rerythropolis_dil3
```
...
plt.title(
    "Curva de crecimiento Rhodococcus erythropolis",
    fontsize=14
)
...
plt.savefig(
    "./Rerythropolis_dil3/curva_crecimiento.png",
    dpi=300,
    bbox_inches="tight"
)
```
